...
export const Carousel = ({ title, children }) => {
  return (
      <>
    <div id="homepage-carousel" className="relative w-2/3 border rounded mb-2" data-carousel="static">
        <div className="overflow-hidden relative h-56  rounded-lg sm:h-64 xl:h-80 2xl:h-96">
            <div className="duration-700 ease-in-out" data-carousel-item>
                <h1 className="text-center py-20">Slide 1</h1>
            </div>
            <div className="hidden duration-700 ease-in-out" data-carousel-item>
                <h1 className="text-center py-20">Slide 2</h1>
            </div>
            <div className="hidden duration-700 ease-in-out" data-carousel-item>
                <h1 className="text-center py-20">Slide 3</h1>
            </div>
        </div>
